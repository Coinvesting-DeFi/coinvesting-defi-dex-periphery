...
enum RouterVersion {
  CoinvestingDeFiRouter01 = 'CoinvestingDeFiRouter01',
  CoinvestingDeFiRouter02 = 'CoinvestingDeFiRouter02'
}

describe('CoinvestingDeFiRouter{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        [RouterVersion.CoinvestingDeFiRouter01]: fixture.router01,
        [RouterVersion.CoinvestingDeFiRouter02]: fixture.router02
    ...
    describe(routerVersion, () => {
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.CoinvestingDeFiRouter01]: 112371,
              [RouterVersion.CoinvestingDeFiRouter02]: 112371
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
      ...
      describe('swapExactETHForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.CoinvestingDeFiRouter01]: 149385,
              [RouterVersion.CoinvestingDeFiRouter02]: 149385
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
...
describe('CoinvestingDeFiRouter02', () => {
  const provider = new MockProvider({
    hardfork: undefined,
    mnemonic: process.env.MNEMONIC,
    gasLimit: 9999999
...
describe('fee-on-transfer tokens', () => {
  ...
  beforeEach(async function() {
    ...
    pair = new Contract(pairAddress, JSON.stringify(ICoinvestingDeFiPair.abi), provider).connect(wallet)
  })
